...
from .interpolation import InterpolationOptions, rope
...
class FluxAttnProcessor:
    ...
    def __call__(
        ...
        if attn.added_kv_proj_dim is not None: # double stream
...
class FluxPosEmbed(nn.Module):
    def __init__(self, theta: int, axes_dim: List[int], opts: InterpolationOptions):
        super().__init__()
...
class FluxTransformer2DModel(
    ...
    def __init__(
        ...
        self.pos_embed = FluxPosEmbed(theta=10000, axes_dim=axes_dims_rope, opts=interpolation_opts)
